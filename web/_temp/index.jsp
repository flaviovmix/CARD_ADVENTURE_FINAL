        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Novo Registro</a>
              </li>
              <li class="nav-item">
                <div>
                  <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <div class="area-info-personagem" id="areaInfoPersonagem">
                        ...
                        <div class="tabela">
                            <table>
                                ...
                                %>
                                  <tr><td class="chave"><strong><%= atributo.getChave() %>:</strong></td><td><%= atributo.getValor() %></td></tr>
                                 <% } %>
...
<div class="area-titulo-da-fase mostrar" id="area-titulo-da-fase" data-nome="<%= card.getNome() %>">
  <span id="areaTituloTexto"><%= card.getNome() %></span>
</div>
